...
namespace AWS_Test
{
    public class AbbreviatingTheProductOfARange_AWS_Exam
    {
        /*
        ...
        public static string AbbreviateProduct(int left, int right)
        {
            string result = "";
            ...
            zeroCount = sumResult.ToString().Count(c => c == '0');

            return $"{sumResult.ToString().Replace("0", "")}e{zeroCount}";
        }
    }
}
